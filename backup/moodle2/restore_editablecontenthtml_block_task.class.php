 ...
 * TODO: Finish phpdocs
 */
class restore_editablecontenthtml_block_task extends restore_block_task {
    ...
    static public function define_decode_contents() {
        ...
        $contents[] = new restore_editablecontenthtml_block_decode_content('block_instances', 'configdata', 'block_instance');
 ...
 */
class restore_editablecontenthtml_block_decode_content extends restore_decode_content {
    ...
    protected function get_iterator() {
        ...
        $sql = "SELECT t.id, $fieldslist
                 ...
                 WHERE b.backupid = ?
                   AND b.itemname = ?
                   AND t.blockname = 'editablecontenthtml'";
